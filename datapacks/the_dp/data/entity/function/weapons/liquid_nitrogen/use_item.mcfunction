...
execute if items entity @s weapon.offhand flint[custom_model_data={strings:["nitrogen"]}] run item modify entity @s weapon.offhand entity:fire_extinguisher_durability
execute if items entity @s weapon.mainhand flint[custom_model_data={strings:["nitrogen"]}] run item modify entity @s weapon.mainhand entity:fire_extinguisher_durability
