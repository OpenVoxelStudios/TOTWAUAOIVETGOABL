...
execute if score phase phase matches 5.. if predicate {"condition":"minecraft:random_chance","chance":0.6} run data modify storage dp:entity entity set value "crown_piranha"
