...
execute if score @s piranha_cooldown matches ..0 if entity @p[tag=!dead,distance=0..4,gamemode=!spectator] if entity @s[tag=aj.entity_crown_piranha.root] run scoreboard players set @s piranha_cooldown 125
