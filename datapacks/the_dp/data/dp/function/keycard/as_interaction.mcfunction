...
data merge entity @n[type=block_display,tag=entrance_door,distance=0..20] {transformation:{translation:[-0.5,4.6,-0.5]},start_interpolation:1,interpolation_duration:40}
