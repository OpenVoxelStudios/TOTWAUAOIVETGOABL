...
scoreboard players set bossbar phase 24000
...
execute positioned 14 -58 35 if score death_timer phase matches 24000.. run effect give @a[distance=0..58] wither infinite 10 true
...
execute if score death_timer phase matches 10000.. as @a at @s if predicate {"condition":"minecraft:all_of","terms":[{"condition":"minecraft:entity_properties","entity":"this","predicate":{"periodic_tick":180}},{"condition":"minecraft:random_chance","chance":0.5}]} \
run particle minecraft:campfire_cosy_smoke ~ ~5 ~ 2 2 2 0 5 normal @s


execute if score death_timer phase matches 15000.. as @a at @s if predicate {"condition":"minecraft:all_of","terms":[{"condition":"minecraft:entity_properties","entity":"this","predicate":{"periodic_tick":120}},{"condition":"minecraft:random_chance","chance":0.5}]} \
run particle minecraft:campfire_cosy_smoke ~ ~5 ~ 2 2 2 0 5 normal @s

execute if score death_timer phase matches 20000.. as @a at @s if predicate {"condition":"minecraft:all_of","terms":[{"condition":"minecraft:entity_properties","entity":"this","predicate":{"periodic_tick":80}},{"condition":"minecraft:random_chance","chance":0.6}]} \
run particle minecraft:campfire_cosy_smoke ~ ~5 ~ 2 2 2 0 5 normal @s

execute if score death_timer phase matches 24000.. as @a at @s if predicate {"condition":"minecraft:all_of","terms":[{"condition":"minecraft:entity_properties","entity":"this","predicate":{"periodic_tick":20}},{"condition":"minecraft:random_chance","chance":0.6}]} \
...
execute as @a at @s if score @s music matches 20 run playsound dp:effects.ambience ambient @s ~ ~ ~ 0.6 1.0 0.0