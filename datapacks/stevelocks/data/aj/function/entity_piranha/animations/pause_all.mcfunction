...
tag @s remove aj.entity_piranha.animation.small_grow.playing
tag @s remove aj.entity_piranha.animation.small_idle.playing
tag @s remove aj.entity_piranha.animation.medium_grow.playing
