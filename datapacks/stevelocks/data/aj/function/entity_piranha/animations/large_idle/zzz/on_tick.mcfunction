...
execute if score @s aj.tween_duration matches 0 run function aj:entity_piranha/animations/large_idle/zzz/zzz/0 with storage animated_java:temp entry.data.uuids_by_name
execute if score @s aj.large_idle.frame matches -1 run function aj:entity_piranha/animations/large_idle/zzz/function_keyframe_loop_patch
